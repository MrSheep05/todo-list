...
class _$AccountModelImpl extends _AccountModel {
  const _$AccountModelImpl({this.uid, this.username, this.email}) : super._();
  ...
  @override
  String toString() {
    return 'AccountModel(uid: $uid, username: $username, email: $email)';
  }
...
abstract class _AccountModel extends AccountModel {
  const factory _AccountModel(
      {final String? uid,
      final String? username,
      final String? email}) = _$AccountModelImpl;
